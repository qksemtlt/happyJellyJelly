    ...
    class EventClicking extends Interaction {
        constructor(settings) {
            ...
            this.handleSegClick = (ev, segEl) => {
                ...
                let selectyear = 1900+seg.eventRange.range.start.getYear();
                let selectmonth = 1+seg.eventRange.range.start.getMonth();
                let selectday = seg.eventRange.range.start.getDate();
                let selectDate = `${selectyear}-${String(selectmonth).padStart(2, '0')}-${String(selectday).padStart(2, '0')}`;
...
//                    let url = hasUrlContainer ? hasUrlContainer.querySelector('a[href]').href : '/diary/select';
                    ...
                    if (url && !ev.defaultPrevented) {
                       // window.location.href = url+"?selectDate="+selectDate+"&id="+diaryId;
                    }
                }
            };
    ...
    class TableCell extends DateComponent {
        ...
        render() {
            ...
            return (y(DayCellContainer, { elTag: "td", elRef: this.handleRootEl, elClasses: [
                ...
                y("a", { className: "fc-daygrid-day-number" , href: "/main", 
	                onClick: (e) => {
					    console.log("Link clicked");
					     e.preventDefault(); // 주석 해제하여 기본 동작 확인
                	}
                }, "\u00A0"))) : undefined,
                ...
                if (options.weekNumbers && rowKey === 'day') {
                    return (y(WeekNumberContainer, { elTag: "th", elClasses: [
                        ...
                        y(InnerContent, { elTag: "a", elClasses: [
                            ...
                            ], href:"/main", elAttrs: navLinkAttrs })))));
                }
